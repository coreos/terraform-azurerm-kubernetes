...
module "container_linux" {
  source = "github.com/coreos/tectonic-installer//modules/container_linux?ref=1.8.4-tectonic.3"
...
module "resource_group" {
  source = "github.com/coreos/tectonic-installer//modules/azure/resource-group?ref=1.8.4-tectonic.3"
...
module "vnet" {
  source = "github.com/coreos/tectonic-installer//modules/azure/vnet?ref=1.8.4-tectonic.3"
...
module "etcd" {
  source = "github.com/coreos/tectonic-installer//modules/azure/etcd?ref=1.8.4-tectonic.3"
...
module "ignition_masters" {
  source = "github.com/coreos/tectonic-installer//modules/ignition?ref=1.8.4-tectonic.3"
...
module "masters" {
  source = "github.com/coreos/tectonic-installer//modules/azure/master-as?ref=1.8.4-tectonic.3"
...
module "workers" {
  source = "github.com/coreos/tectonic-installer//modules/azure/worker-as?ref=1.8.4-tectonic.3"
...
module "dns" {
  source = "github.com/coreos/tectonic-installer//modules/dns/azure?ref=1.8.4-tectonic.3"
