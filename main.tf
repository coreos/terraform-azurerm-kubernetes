...
module "resource_group" {
  source = "github.com/coreos/tectonic-installer//modules/azure/resource-group?ref=1.7.3-tectonic.2"
...
module "vnet" {
  source = "github.com/coreos/tectonic-installer//modules/azure/vnet?ref=1.7.3-tectonic.2"
...
module "etcd" {
  source = "github.com/coreos/tectonic-installer//modules/azure/etcd?ref=1.7.3-tectonic.2"
...
module "masters" {
  source = "github.com/coreos/tectonic-installer//modules/azure/master-as?ref=1.7.3-tectonic.2"
...
module "workers" {
  source = "github.com/coreos/tectonic-installer//modules/azure/worker-as?ref=1.7.3-tectonic.2"
...
module "dns" {
  source = "github.com/coreos/tectonic-installer//modules/dns/azure?ref=1.7.3-tectonic.2"
