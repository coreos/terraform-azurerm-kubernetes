module "bootkube" {
  source = "github.com/coreos/tectonic-installer//modules/bootkube?ref=1.7.3-tectonic.2"
...
module "tectonic" {
  source   = "github.com/coreos/tectonic-installer//modules/tectonic?ref=1.7.3-tectonic.2"
  platform = "azure"
...
module "flannel-vxlan" {
  source = "github.com/coreos/tectonic-installer//modules/net/flannel-vxlan?ref=1.7.3-tectonic.2"
...
module "calico-network-policy" {
  source = "github.com/coreos/tectonic-installer//modules/net/calico-network-policy?ref=1.7.3-tectonic.2"
