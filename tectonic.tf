module "kube_certs" {
  source = "github.com/coreos/tectonic-installer//modules/tls/kube/self-signed?ref=1.7.5-tectonic.1"
...
module "etcd_certs" {
  source = "github.com/coreos/tectonic-installer//modules/tls/etcd?ref=1.7.5-tectonic.1"
...
module "ingress_certs" {
  source = "github.com/coreos/tectonic-installer//modules/tls/ingress/self-signed?ref=1.7.5-tectonic.1"
...
module "identity_certs" {
  source = "github.com/coreos/tectonic-installer//modules/tls/identity/self-signed?ref=1.7.5-tectonic.1"
...
module "bootkube" {
  source = "github.com/coreos/tectonic-installer//modules/bootkube?ref=1.7.5-tectonic.1"
...
module "tectonic" {
  source   = "github.com/coreos/tectonic-installer//modules/tectonic?ref=1.7.5-tectonic.1"
  platform = "azure"
...
module "flannel-vxlan" {
  source = "github.com/coreos/tectonic-installer//modules/net/flannel-vxlan?ref=1.7.5-tectonic.1"
...
module "calico-network-policy" {
  source = "github.com/coreos/tectonic-installer//modules/net/calico-network-policy?ref=1.7.5-tectonic.1"
