...
module "bootkube" {
  source = "github.com/coreos/tectonic-installer//modules/bootkube?ref=1.8.9-tectonic.1"
...
module "tectonic" {
  source   = "github.com/coreos/tectonic-installer//modules/tectonic?ref=1.8.9-tectonic.1"
  platform = "azure"
...
module "flannel_vxlan" {
  source = "github.com/coreos/tectonic-installer//modules/net/flannel_vxlan?ref=1.8.9-tectonic.1"
...
module "calico" {
  source = "github.com/coreos/tectonic-installer//modules/net/calico?ref=1.8.9-tectonic.1"
...
module "canal" {
  source = "github.com/coreos/tectonic-installer//modules/net/canal?ref=1.8.9-tectonic.1"
