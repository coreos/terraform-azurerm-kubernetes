...
module "kube_certs" {
  source = "github.com/coreos/tectonic-installer//modules/tls/kube/self-signed?ref=1.7.9-tectonic.3"
...
module "etcd_certs" {
  source = "github.com/coreos/tectonic-installer//modules/tls/etcd/signed?ref=1.7.9-tectonic.3"
...
module "ingress_certs" {
  source = "github.com/coreos/tectonic-installer//modules/tls/ingress/self-signed?ref=1.7.9-tectonic.3"
...
module "identity_certs" {
  source = "github.com/coreos/tectonic-installer//modules/tls/identity/self-signed?ref=1.7.9-tectonic.3"
...
module "bootkube" {
  source = "github.com/coreos/tectonic-installer//modules/bootkube?ref=1.7.9-tectonic.3"
...
module "tectonic" {
  source   = "github.com/coreos/tectonic-installer//modules/tectonic?ref=1.7.9-tectonic.3"
  platform = "azure"
...
module "flannel_vxlan" {
  source = "github.com/coreos/tectonic-installer//modules/net/flannel-vxlan?ref=1.7.9-tectonic.3"
...
module "calico" {
  source = "github.com/coreos/tectonic-installer//modules/net/calico?ref=1.7.9-tectonic.3"
...
module "canal" {
  source = "github.com/coreos/tectonic-installer//modules/net/canal?ref=1.7.9-tectonic.3"
